...
function ProductoForm({ onSubmit, productoAEditar, onCancel }) {
    ...
    const validar = () =>{
        ...
        if (nombre.trim()) {
            erroresValidacion.push('El nombre está vacio.');
        } if (precio === '' || isNaN(precio) || Number(precio) <= 0) { //validamos para que no este vacio, para que sea un numero y que no sea un 0
